...
class RecInc3D(nn.Module):
    def __init__(self,
        ...
        if is3d:
            self.G1 = GroupConv(cin, cout, (7, 7, 7), (1, 2, 2))
            self.G2 = GroupConv(lin, cout * 2, (5, 5, 5), 1)
            self.G3 = GroupConv(lin * 2, cout * 4, (2, 3, 3), 1)
        else:
        ...
        self.G4 = GroupConv(lin * 4, cout * 8, (1, 2, 2), 1)
